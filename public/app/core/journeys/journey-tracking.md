...
| Event                 | Trigger                                                                             | Action                                                     |
| --------------------- | ----------------------------------------------------------------------------------- | ---------------------------------------------------------- |
| Start                 | `grafana_homepage_alerts_card_clicked` (alert_detail, view_all_alerts, create_rule) | Journey starts; `action` selects the end leg               |
...
- `msSinceLoad` — dwell: milliseconds between the card's data becoming visible and the click. Carried as an additive prop on the loud `grafana_homepage_alerts_card_clicked` event and mirrored onto the journey.
